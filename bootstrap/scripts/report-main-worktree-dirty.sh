...
# local changes. Used by `wt merge` post-merge probes; rower merges do
...
echo "[main-worktree-dirty] rower merges do not own this dirt; inspect or clean: git -C $root status --short" >&2
